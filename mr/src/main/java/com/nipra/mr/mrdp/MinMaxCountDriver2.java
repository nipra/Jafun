...
import com.nipra.mr.mrdp.utils.MRDPUtils;
...
public class MinMaxCountDriver2 extends Configured implements Tool {
...
//	@Override
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(MinMaxCountDriver2.class);
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new MinMaxCountDriver2(), args);
